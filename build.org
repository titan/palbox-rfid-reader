...
* 项目配置
** rules
#+begin_src makefile :tangle /dev/shm/rfid-reader/libopencm3.rules.mk
  ##
...
#+end_src
** target
#+begin_src makefile :tangle /dev/shm/rfid-reader/libopencm3.target.mk
  ##
  ## This file is part of the libopencm3 project.
  ##
  ## Copyright (C) 2009 Uwe Hermann <uwe@hermann-uwe.de>
...
#+end_src
** Makefile
#+begin_src makefile :tangle /dev/shm/rfid-reader/Makefile
  BINARY = rfid-reader

  OBJS += base64.o console.o core-fsm.o epigyny.o hash.o led.o packet.o proto-fsm.o rfid-fsm.o rfid.o rfid_payload.o ring.o sbtree.o stack.o task-fsm.o utility.o uart.o zeropack.o

  CFLAGS +=-D RFID_READER_ID=$(RFID_READER_ID) -D ZEROPACK_RFID_PAYLOAD_ENABLED
...
#+end_src
** config
#+begin_src makefile :tangle /dev/shm/rfid-reader/config.orig
