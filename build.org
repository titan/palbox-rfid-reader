...
#+begin_src makefile :tangle /dev/shm/rfid-reader/Makefile
  ...
  OBJS += base64.o console.o core-fsm.o epigyny.o hash.o led.o packet.o proto-fsm.o rfid-fsm.o rfid.o rfid_payload.o ring.o sbtree.o stack.o utility.o uart.o zeropack.o
